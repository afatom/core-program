 ...
 *  user can send any kind of data/structure or msg he wants.
 *
 * @Critical Warning: All Channel functions are unsafe functions! user 
 * is responsible for providing valid data and valid channel pointer! 
 * if the caller passes invalid data, behavior is undefined and channel 
 * Crashses may occur!
 *
 *  @author adham
 * 
