...
LgControl_t::LgControl_t(IRegistrar_t* _reg, const AgentConfig_t& _lgControlConfig)
{
...
{
	cout<<"Lg_Controller Received Event Bellow:"<<endl;
	cout<<*_pevent<<endl;
}
...
void LgControl_t::Run()
{
	...
	m_registrar->Subscribe(this, m_log);
}
