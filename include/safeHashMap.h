#ifndef __SAFEHASHMAP_H__
#define __SAFEHASHMAP_H__

#include <stddef.h>  /* size_t */
#define NDEBUG
/** 
 *  @file HashMap.h
 *  @brief Generic Hash map, Multi threaded safe ADT Hash Map of key-value 
 *  pairs implemented with separate chaining using generic double linked lists.
 * 	
 *	
...
typedef enum MapResult {
	...
	MAP_KEY_NOT_FOUND_ERROR, 		/**< Key not found 	*search case*/
	MAP_ALLOCATION_ERROR, 			/**< Allocation error 	 		*/
	MAP_INVALID_FUNCTION_ARGUMENTS_ERROR
} MapResult;
...
/** 
 * @brief Create a new MT safe hash map with given capcity and key characteristics.
